...
export abstract class IMutation {
  ...
  abstract updateManyPlayers(
    data: PlayerUpdateInput,
    where?: PlayerWhereInput,
  ): BatchPayload | Promise<BatchPayload>
  abstract deleteManyGames(
    where?: GameWhereInput,
  ): BatchPayload | Promise<BatchPayload>
  abstract deleteManyPlayers(
    where?: PlayerWhereInput,
  ): BatchPayload | Promise<BatchPayload>
}
...
export abstract class IQuery {
  ...
  abstract playersConnection(
    ...
    first?: number,
    last?: number,
  ): PlayerConnection | Promise<PlayerConnection>
...
export abstract class ISubscription {
  ...
  ): PlayerSubscriptionPayload | Promise<PlayerSubscriptionPayload>
}
